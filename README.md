...
The embedding-2-prompt reversion model used in the experiment, named "coco_prefix-049.pt", is uploaded to both `https://huggingface.co/snownhonoka/attacks-on-approximate-caches-in-text_to_image-diffusion-models` and `https://zenodo.org/records/17959605`, trained by using diffutiondb dataset. You can also train your new one by using the training scripts provided in this repo.
