...
if __name__ == "__main__":
    ...
    for model in models:
        if model == "flux":
            ...
            marker_name =  "Mcdonald"
            marker_path = "Mcdonald.png"
        ...
        for filename in files:
            ...
            if model in filename:
                ...
                if elements[1] not in success_count:
                    success_count[elements[1]] = 0
                if len(metadata['logo_regions'][0]) > 0:
                    success_count[elements[1]] += 1
        print(f"model {model}'s success rate is {success_count}")
    # print(len(metadata['logo_regions'][0]))
    # metadata['detected_objects'][0].save("poisson_filter/extract.png")